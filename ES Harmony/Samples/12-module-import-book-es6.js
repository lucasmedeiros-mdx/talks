...
System.register("12-module-import-book", [], function() {
  "use strict";
  var __moduleName = "12-module-import-book";
  var Book = System.get("7-product-class").Book;
  var product = new Book('Speaking Javascript', 'Axel Rauschmayer', 39.28);
  product.buy(2);
  return {};
});
System.get("12-module-import-book" + '');
